...
export default function FoodLogList() {
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      console.error(err);
      toast.error("Failed to fetch meal logs");
      setLogs([]);
    } finally {
      setLoading(false);
    }
            ...
            <div className="container-xxl flex-grow-1 container-p-y">
              <div className="container">
                ...
                <p style={{ color: theme.textSecondary }}>
                  Browse and track your daily food logs
                </p>
                        ...
                        >
                          ...
                          >
                            ...
                            <ActionBtn
                              ...
                              onClick={() =>
                                navigate(
                                  `/user-dashboard/foodlog-detail/${log._id}`
                                )
                              }
                            >
                            ...
                            <ActionBtn
                              ...
                              onClick={() =>
                                navigate(
                                  `/user-dashboard/foodlog-form/${log._id}`
                                )
                              }
                            >
